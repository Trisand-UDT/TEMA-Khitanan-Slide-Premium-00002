...
var initCoreInvitation = function initCoreInvitation() {
  ...
  // tampilkan nama tamu
  var guestName = tscover.dataset.guest;
  ...
  var groupName = tscover.dataset.group;
...
var tscover = document.getElementById("tscover");
var lang = document.documentElement.lang;
  ...
  if (loader && tscover) {
    window.addEventListener("load", function () {
      setTimeout(function () {
        ...
        tscover.style.display = "block"; // Gunakan "block" bukan "inherit"
      }, 100);
    });
...
var resizeWorkspace = function resizeWorkspace() {
  ...
  tscover.style.height = "".concat(newHeight, "px");
...
// Detect slide
var slides = document.querySelectorAll(".tscover_slide");
var menus = document.querySelectorAll(".tscover_menu_item");
var smMenu = document.getElementById("smMenu");
var menuContainer = document.querySelector(".tscover_menu_list");
